...
# there is a dropout layer after the first convolution layer AND the initial dense layer.
# the thought is that this may broaden the ways input noise is passed, meaning the generator
# needs to rely more heavily on real image features rather than patterns in the noise that work 
